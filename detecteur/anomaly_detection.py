...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.third_frame_button_2.grid(row=5, column=0, padx=20, pady=10)
        ...
        self.danger_treshold_entry.grid(row=6, column=0, padx=20, pady=10)

        self.suspect_treshold_entry = customtkinter.CTkEntry(self.third_frame, placeholder_text="suspect treshold")
        self.suspect_treshold_entry.grid(row=7, column=0, padx=20, pady=10)
    ...
    def predict(self):
        ...
        if sum(y_pred_suspect)>0:
            self.third_frame_button_5.configure(text="      Suspicious anomalies detected", text_color="#1E6AA4", image=self.logo_anomaly)
            self.open_toplevel_suspect()
            self.toplevel_window_suspect.focus()
        else:
            self.third_frame_button_5.configure(text="No Suspicious anomalies detected !", text_color="green", image='')
